...
import { getAttendanceEvents } from "../schedule/store/instructorSlice"
...
const index = () => {
  ...
  const {
    attedanceEvents: { events, loading, totalPages },
  ...
  //     dispatch(getAttendanceEvents({ query, page, perPage }))
  //   }
  // }, [])
