...
import { getActivity } from "./store/hobSlice"
...
const index = () => {
  ...
  const { users, totalPages, loading } = useSelector((state) => state.hobs)
      ...
      <div className="card">
        <form className="card-body">
          <div className="d-flex justify-content-between align-items-center">
            <h2 className="h5">HOB(House of Brands) List</h2>
            <button
              type="button"
