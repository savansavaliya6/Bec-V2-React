...
import { deleteGuest } from "./store/conferenceRoomSlice"
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Delete Conference Room Name</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          Are you sure you want to delete this Conference Room Name?
        </Modal.Body>
        <Modal.Footer>
